...
<body>
	...
	<div class="container">
		<div class="row">
			<form method="post" action="commUpdateAction.jsp?commID=<%=commID%>">
					...
					<tbody>
						<tr>
							<td><input type="text" class="form-control"
								placeholder="글 제목" name="commTitle" maxlength="100"
								value="<%=comm.getCommTitle()%>"></td>
						</tr>
						<tr>
							<td><textarea class="form-control" placeholder="글 내용"
									name="commContent" maxlength="16000" style="height: 350px;"><%=comm.getCommContent()%></textarea></td>
						</tr>
					</tbody>
